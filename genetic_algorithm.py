...
def start(obstacles, path_points, path_validity):
    ...
    population = _generate_population(path_points, obstacles, path_validity)    # 生成所有傳播路徑 (100000001000100010100001001) One-Hot 解碼
    path_lengths = []

    for chromosome in population:   
        path_lengths.append(_calculate_path_length(chromosome, path_points))    # 計算所有長度
